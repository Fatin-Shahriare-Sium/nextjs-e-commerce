        ...
        <div className='search-panel'>
           ...
           <div className="search-panel__main">
               <div className="search-panel__navbar">
                    ...
                    <p style={{fontSize:'1.5rem',fontWeight:'500'}} >5000 products found</p>
                    </div>
               ...
               <div className="search-panel__results">
                {searchedProducts && searchedProducts.map((sig,index)=><SectionCard href='/' title={sig.title} img={sig.img[0].src} price={sig.price} priceoff={sig.priceOff}/>)}
               </div>
           </div>
        </div>
    )
