...
const OrderDetails = () => {
    ...
    return (
        <div style={{ height: '83vh' }} className='order-details__container container-fluid mt-3'>
            <div className='row'>
                <div style={{ overflowY: 'auto', borderRight: '2px solid red' }} className='order-details__sidebar col-md-3'>
                ...
                <div className='order-details__shower col-md-9'>
                    <SingleOrderSummery order={selectedOrder} />
