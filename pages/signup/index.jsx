...
const Index = () => {
  ...
  return (
    <div className="signup">
      ...
      <form
        onSubmit={(event) => {
          handleSignUp(event, handleLoadingShower);
        }}
      >
        <div class="mb-3">
      ...
      <ToastContainer position="top-center" newestOnTop={false} closeOnClick rtl={false} pauseOnFocusLoss draggable={false} autoClose={2000} pauseOnHover />
    </div>
  );
};
